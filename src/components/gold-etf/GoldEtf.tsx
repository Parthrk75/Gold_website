...
//       <h2 className="text-2xl font-semibold text-center text-gray-800 mb-6">📊 Gold Price Data</h2>
...
//             className="border px-4 py-2 rounded-md shadow-sm w-full text-gray-700"
//           />
//         </div>
...
//       {/* Status Messages */}
//       {!startDate || !endDate ? (
//         <p className="text-yellow-600 text-center font-medium">⚠️ Please select both start and end dates to fetch data.</p>
//       ) : loading ? (
//         <p className="text-blue-500 text-center font-medium">🔄 Loading data...</p>
//       ) : error ? (
//         <p className="text-red-500 text-center font-medium">❌ {error}</p>
//       ) : data.length === 0 ? (
//         <p className="text-gray-500 text-center font-medium">📉 No data available for the selected date range.</p>
//       ) : (
//         <>
//           {/* Download Button */}
...
//               className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md disabled:bg-gray-400"
//             >
//               ⬇️ Download Excel
//             </button>
//           </div>
...
//                     <td className="px-4 py-2">{item.open ?? "N/A"}</td>
//                     <td className="px-4 py-2">{item.high ?? "N/A"}</td>
//                     <td className="px-4 py-2">{item.low ?? "N/A"}</td>
//                     <td className="px-4 py-2">{item.close ?? "N/A"}</td>
//                   </tr>
//                 ))}
//               </tbody>
//             </table>
